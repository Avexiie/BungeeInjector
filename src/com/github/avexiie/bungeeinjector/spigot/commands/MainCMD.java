package com.github.avexiie.bungeeinjector.spigot.commands;

import com.github.avexiie.bungeeinjector.spigot.SpigotInjector; 
...
public class MainCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            sender.sendMessage("§cUsage: /bungeeinjector reload");
        }
